...
/*   Updated: 2018/06/12 12:10:07 by ldedier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define EPSILON3 0.000001
# define EPSILON4 0.00000001 
# define SPEED 0.1
# define MAX_BOUNCE 4
# define AA_SQ_SIZE 1
...
typedef struct				s_object
{
	...
	void					(*print_caracteristics)(struct s_object obj, int f);
	t_point3d				(*normal_func)(struct s_object, t_point3d, t_line);
...
void						ft_keys_event(t_world *wod, SDL_Event event, int d);
...
t_object					create_sphere(t_point3d ps, double r, t_color co);
...
void						ft_process_parsing_rot(t_parser *prsr, t_world *wo,
							char *line);
...
void						ft_process_tag_pop(t_parser *parser);
void						ft_parse_src(t_parser *parser, t_world *w, char *l);
...
void						ft_parse_refraction(t_parser *p, t_world *w,
								char *l);
void						ft_parse_reflection(t_parser *p, t_world *w,
								char *l);
...
void						ft_parse_intensity(t_parser *p, t_world *w,
								char *l);
void						ft_parse_negative(t_parser *par, t_world *w,
								char *l);
void						ft_parse_pert(t_parser *p, t_world *w, char *l);
void						read_pert_type(t_parser *par, t_perturbations *p);
void						ft_parse_resolution(t_parser *p, t_world *w,
								char *l);
void						ft_parse_antialiasing(t_parser *p, 
								t_world *w, char *l);
...
void						ft_parse_ellipsoid_abc(t_parser *p, t_world *w,
								char *l);
void						ft_parse_goursat_ab(t_parser *p, t_world *w,
								char *l);
void						ft_parse_big_radius(t_parser *p, t_world *w,
								char *l);
void						ft_parse_small_radius(t_parser *p, t_world *w,
								char *l);
...
void						ft_process_parsing_light_start(t_parser *p,
								t_world *w);
...
void						ft_give_default_characteristics_cobject(char *att,
	   						t_cobject *cobject);
void						ft_process_parsing_cut_start(t_parser *p,
								t_world *w);
void						ft_process_parsing_cut_xyz(t_parser *p, t_world *w,
								char *l);
void						ft_process_parsing_inequality(t_parser *p,
							t_world *w, char *l);
void						ft_process_parsing_value(t_parser *p, t_world *w,
								char *l);
void						ft_process_parsing_cut_color(t_parser *p,
								t_world *w, char *l);
void						ft_process_parsing_mod_color(t_parser *p,
								t_world *w, char *l);
void						ft_process_parsing_inequality(t_parser *p,
								t_world *w, char *l);
void						ft_process_parsing_value(t_parser *p, t_world *w,
								char *l);
void						ft_process_parsing_mod_value(t_parser *p,
								t_world *w, char *l);
...
void						ft_process_parsing_stack_2(t_parser *p, t_world *w,
								char *l);
void						ft_process_parsing_mod_start(t_parser *p,
								t_world *w);
void						ft_parse_nb_spheres(t_parser *p, t_world *w,
								char *l);
void						ft_parse_spheres_radius(t_parser *p, t_world *w,
								char *l);
...
void						ft_parse_stretch_x(t_parser *p, t_world *w,
								char *l);
void						ft_parse_stretch_y(t_parser *p, t_world *w,
								char *l);
int							parse_light(char *line, t_light *rlight);
void						ft_give_object_name(t_object *object, char *name);
void						ft_transfer_mod_parser(t_parser *par, t_world *w);
void    					set_func(t_object *obj, void (*print_caracteristics)
								(t_object, int));
...
t_point3d					reflection(t_point3d n, t_point3d v);
t_point3d					refraction(t_hit *hit, t_line *line, double ref);
...
t_intcolor					add_scale_intcolors(t_intcolor icol1, t_intcolor i,
								double scale);
...
t_point3d					screen2world(t_pixel pix, t_world *w, t_pixel aa);
void						paint_pixel(t_pixel p, t_color c, int *pixels,
								t_pixel size);
t_line						newray(t_point3d p, t_point3d vec);
t_color						ray_color(t_line ray, t_world *world,
							int bounce, int fast);
t_hit						*trace(t_line line, t_cobjlist *cobjlist);
void						castshadows(t_world *w, t_hit *h, t_shadow **s);
...
void						start_thread(t_world *world, int p_y, int i,
								int *pxls);
...
**normals
*/
t_point3d					normal_sphere(t_object sp, t_point3d t, t_line l);
t_point3d					normal_cone(t_object sph, t_point3d t, t_line l);
t_point3d					normal_plane(t_object sph, t_point3d t, t_line l);
t_point3d					normal_cylinder(t_object s, t_point3d t, t_line l);
t_point3d					normal_ellipsoid(t_object s, t_point3d t, t_line l);
t_point3d					normal_goursat(t_object sp, t_point3d t, t_line l);
t_point3d					normal_roman(t_object sp, t_point3d t, t_line l);
t_point3d					normal_piriform(t_object sp, t_point3d t, t_line l);
t_point3d					normal_lemniscate(t_object sp, t_point3d t,
								t_line l);
t_point3d					normal_torus(t_object sp, t_point3d t, t_line l);
t_point3d					normal_paraboloid(t_object spher, t_point3d t,
								t_line l);
t_point3d					normal_hyperboloid(t_object sphere, t_point3d
								t, t_line l);
t_point3d					normal_triangle(t_object ob, t_point3d p, t_line l);
t_point3d					normal_mobius(t_object obj, t_point3d p, t_line l);
...
**cuts
*/
int							ft_evaluate_cut(t_cut cut, t_point3d p, t_hit hit);
double						get_smallest_legal_pos_val(t_hit newh, t_sols sols,
								double min,	t_auxtracer aux);
double						get_smallest_legal_pos_val_t(t_hit newhi, t_sols s,
								double min, t_line line);

/*
**negatives
*/
int							is_inside_other(t_hit h, t_objlist *objlist, int ne,
								t_object *other);
...
void    					set_funcs(t_object *obj,
								int (*intersect_func)(t_line, t_object,
								double[MAX_DEGREE]),
								int (*inside_func)(t_hit, t_object),
								t_point3d (*normal_func)(t_object,
								t_point3d, t_line));
...
** automatics
*/
void						ft_process_automatic(t_parser *parser, t_world *wo);
void						ft_compute_automatic_adn(t_cobject *cobject);

/*
** defining
*/
void						ft_process_switch_list_cobject(t_cobjlist **cobj,
							t_cobjlist **defcobjlist);
int							already_exists_defcobj(char *name, t_cobjlist *cob);
t_cobject					*get_defcobject(char *name, t_cobjlist *cobjlst);

/*
**translations
*/
t_point3d					translate_vec(t_point3d p, t_point3d v, double sca);
...
**rotations
*/
t_point3d					rotate_axis(t_point3d v, t_point3d axis, double an);
...
int							texture_cylinder(t_object obj, t_hit *hit,
								t_bmp_parser p);
int							texture_plane(t_object o, t_hit *h, t_bmp_parser p);
int							texture_cone(t_object o, t_hit *h, t_bmp_parser p);
...
void						ft_print_sphere_caracteristics(t_object ob, int fd);
void						ft_print_plane_caracteristics(t_object ob, int fd);
void						ft_print_cone_caracteristics(t_object o, int fd);
void						ft_print_cylinder_caracteristics(t_object o, int f);
void						ft_print_ellipsoid_caracteristics(t_object o,
								int f);
void						ft_print_torus_caracteristics(t_object ob, int fd);
void						ft_print_goursat_caracteristics(t_object ob, int f);
void						ft_print_lemniscate_caracteristics(t_object o, 
								int f);
void						ft_print_roman_caracteristics(t_object o, int fd);
void						ft_print_piriform_caracteristics(t_object o, int f);
void						ft_print_hyperboloid_caracteristics(t_object o,
								int f);
void						ft_print_paraboloid_caracteristics(t_object o,
								int f);
void						ft_print_triangle_caracteristics(t_object o, int f);
void						ft_print_cobjs_2(t_cobject cobj, char *s, int f);
...
void						ft_print_cobjs_3(t_cobjlist *l, t_cobject c, int f);
...
void						ft_print_light(t_world *w, int f, char *t, int i);
...
*/
void						ft_mouse_motion(t_world *world, SDL_Event event);
void						ft_mouse_button_down(t_world *world, SDL_Event e);
void						ft_mouse_button_up(t_world *world, SDL_Event event);
void						ft_mouse_motion_objects(t_world *wo, SDL_Event e);
void						ft_mouse_motion_objects_6(t_world *wo, SDL_Event e);
void						ft_mouse_motion_lights(t_world *world, SDL_Event e);
void						ft_mouse_motion_others(t_world *world, SDL_Event e);
void						ft_mouse_button_objects(t_world *wo, SDL_Event e);
void						ft_mouse_button_objects_6(t_world *world);
void						ft_mouse_button_objects_7(t_world *world);
void						ft_mouse_button_objects_8(t_world *w, SDL_Event e,
								int x, int y);
void						ft_mouse_button_objects_11(t_world *world);
void						ft_mouse_button_objects_12(t_world *w, int x,
								int y);
void						ft_mouse_button_objects_16(t_world *world, int x,
								int y, int y0);
void							ft_mouse_button_lights(t_world *w, SDL_Event e);
void						ft_mouse_button_lights_6(t_world *world,
								SDL_Event event, int x, int y);
void						ft_mouse_button_others(t_world *w, SDL_Event e);
void						ft_mouse_button_others_6(t_world *world,
								SDL_Event event, int x, int y);
...
t_rangebar					ft_new_rangebar(double n, double m,
								t_pixel x, double *v);
t_grangebar					ft_new_grangebar(double m, double x, t_pixel p,
								int *v);
t_colorpicker				ft_new_colorpicker(t_pixel x, t_pixel s,
								t_color *c);
...
void						ft_add_text(t_world *w, int f, char *t,
								SDL_Color c);
void						ft_add_header_text(t_world *world);
void						ft_color_hue(t_world *world);
void						ft_switch_filter(t_world *world, int fi, int pos);
...
void						ft_fill_menu_surface(t_world *wo, t_bmp_parser b);
void						ft_fill_menu_surface_2(t_world *wd,
									t_bmp_parser bmp, int color);
void						ft_fill_menu_surface_3(t_world *wd,
								t_bmp_parser bmp, int color);
void						ft_menu_others_bloc1_fog(t_world *world);
void						ft_menu_others_bloc1_ambient_color_1(t_world *wo);
void						ft_menu_others_bloc1_ambient_color_2(t_world *wo);
...
void						ft_menu_others_bloc1_grangebars_2(t_world *world,
								int i, int nb_val, float step);
...
void						ft_menu_lights_bloc1_scrollbar_2(t_world *world,
								int i, int *j, int y0);
...
void						ft_menu_lights_bloc2_intensity_color_1(t_world *wo);
void						ft_menu_lights_bloc2_intensity_color_2(t_world *wo);
void						ft_menu_lights_bloc2_rotation(t_world *world);
void						ft_menu_lights_bloc2_type(t_world *world);
void						ft_menu_lights_bloc2_type_3(t_world *world,
								t_bmp_parser bmp);
...
void						ft_menu_objects_bloc2_perturbations_5(t_world *wo);
void						ft_menu_objects_bloc2_perturbations_6(t_world *wo);
void						ft_menu_objects_bloc2_perturbations_7(t_world *wo,
								t_bmp_parser bmp);
void						ft_menu_objects_bloc2_perturbations_8(t_world *wo,
								t_bmp_parser bmp);
void						ft_menu_objects_bloc2_perturbations_9(t_world *wo,
								t_bmp_parser bmp);
...
void						ft_menu_objects_bloc1_scrollbar_6(t_world *world,
								t_cobject cobj, int y0);
void						ft_menu_objects_bloc1_scrollbar_7(t_world *world,
								t_cobjlist *lst, int *i, int *j);
void						ft_menu_objects_bloc1_scrollbar_11(t_world *world,
								t_object obj, int y0);
void						ft_menu_objects_bloc1_scrollbar_12(t_world *world,
								t_object obj, int y0);
void						ft_menu_objects_bloc1_scrollbar_13(t_world *world,
								t_object obj, int y0);
