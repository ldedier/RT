...
/*   Updated: 2018/06/12 06:58:28 by ldedier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

void	ft_key_event5(t_world *e, SDL_Event event, int press)
{
	if (event.key.keysym.sym == SDLK_h)
	{
		...
		ft_key_event6(e, event, press);
}

void	ft_key_event4(t_world *e, SDL_Event event, int press)
{
	...
	else if (event.key.keysym.sym == SDLK_r)
	{
		...
		ft_key_event5(e, event, press);
}

void	ft_key_event3(t_world *e, SDL_Event event, int press)
{
	if (event.key.keysym.sym == SDLK_o)
		...
		ft_key_event4(e, event, press);
}

void	ft_key_event2(t_world *e, SDL_Event event, int press)
{
